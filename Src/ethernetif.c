...
/* USER CODE BEGIN 3 */
	uint8_t	HAL_MAC_Addr[6] = {0xfe,0x80,0x18,0x42,0x9c,0xd8};
/* USER CODE END 3 */
...
//   uint8_t MACAddr[6] ;
  ...
  /* USER CODE BEGIN MACADDRESS */
	 ...
	 heth.Init.MACAddr = &HAL_MAC_Addr[0];
   heth.Init.MACAddr[0]	=	HAL_MAC_Addr[0];
   heth.Init.MACAddr[1]	=	HAL_MAC_Addr[1]; 
   heth.Init.MACAddr[2]	=	HAL_MAC_Addr[2];
   heth.Init.MACAddr[3]	=	HAL_MAC_Addr[3];
   heth.Init.MACAddr[4]	=	HAL_MAC_Addr[4];
   heth.Init.MACAddr[5]	=	HAL_MAC_Addr[5];
